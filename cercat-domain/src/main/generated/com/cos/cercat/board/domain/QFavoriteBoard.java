...
public class QFavoriteBoard extends EntityPathBase<FavoriteBoard> {
    ...
    private static final long serialVersionUID = 1825867004L;
    ...
    public final com.cos.cercat.board.domain.embededId.QFavoriteBoardPK favoriteBoardPK;
    ...
    public QFavoriteBoard(Class<? extends FavoriteBoard> type, PathMetadata metadata, PathInits inits) {
        ...
        this.favoriteBoardPK = inits.isInitialized("favoriteBoardPK") ? new com.cos.cercat.board.domain.embededId.QFavoriteBoardPK(forProperty("favoriteBoardPK")) : null;
