...
public class QBoardAlarm extends EntityPathBase<BoardAlarm> {
    ...
    private static final long serialVersionUID = -1271012188L;
    ...
    public final com.cos.cercat.user.domain.QUser fromUser;
    ...
    // inherited
    public final com.cos.cercat.user.domain.QUser receiveUser;
    ...
    public QBoardAlarm(Class<? extends BoardAlarm> type, PathMetadata metadata, PathInits inits) {
        ...
        this.fromUser = inits.isInitialized("fromUser") ? new com.cos.cercat.user.domain.QUser(forProperty("fromUser"), inits.get("fromUser")) : null;
        this.id = _super.id;
