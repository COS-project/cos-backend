...
public class QAlarm extends EntityPathBase<Alarm> {
    ...
    private static final long serialVersionUID = -240044776L;
    ...
    public QAlarm(Class<? extends Alarm> type, PathMetadata metadata, PathInits inits) {
        ...
        this.receiveUser = inits.isInitialized("receiveUser") ? new com.cos.cercat.user.domain.QUser(forProperty("receiveUser"), inits.get("receiveUser")) : null;
    }
