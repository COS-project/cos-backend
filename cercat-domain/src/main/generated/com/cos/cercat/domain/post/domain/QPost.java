...
public class QPost extends EntityPathBase<Post> {
    ...
    private static final long serialVersionUID = 1952511922L;
    ...
    public QPost(Class<? extends Post> type, PathMetadata metadata, PathInits inits) {
        ...
        this.postComments = inits.isInitialized("postComments") ? new com.cos.cercat.domain.comment.domain.QPostComments(forProperty("postComments")) : null;
