...
public class QMockExamResult extends EntityPathBase<MockExamResult> {
    ...
    private static final long serialVersionUID = -1115211650L;
    ...
    public final com.cos.cercat.domain.mockExam.domain.QMockExam mockExam;
    ...
    public QMockExamResult(Class<? extends MockExamResult> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mockExam = inits.isInitialized("mockExam") ? new com.cos.cercat.domain.mockExam.domain.QMockExam(forProperty("mockExam"), inits.get("mockExam")) : null;
