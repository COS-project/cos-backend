...
/**
 * QCommentaryPost is a Querydsl query type for CommentaryPost
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QCommentaryPost extends EntityPathBase<CommentaryPost> {

    private static final long serialVersionUID = -265536389L;
    ...
    public final com.cos.cercat.domain.mockExam.domain.QQuestion question;
    ...
    public QCommentaryPost(Class<? extends CommentaryPost> type, PathMetadata metadata, PathInits inits) {
        ...
        this.question = inits.isInitialized("question") ? new com.cos.cercat.domain.mockExam.domain.QQuestion(forProperty("question"), inits.get("question")) : null;
