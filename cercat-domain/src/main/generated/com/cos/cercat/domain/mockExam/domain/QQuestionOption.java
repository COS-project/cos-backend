...
public class QQuestionOption extends EntityPathBase<QuestionOption> {
    ...
    private static final long serialVersionUID = -8387338L;
    ...
    public final com.cos.cercat.domain.common.domain.QImage optionImage;

    public final QQuestion question;

    public final com.cos.cercat.domain.mockExam.domain.embededId.QQuestionOptionPK questionOptionPK;
    ...
    public QQuestionOption(Class<? extends QuestionOption> type, PathMetadata metadata, PathInits inits) {
        ...
        this.optionImage = inits.isInitialized("optionImage") ? new com.cos.cercat.domain.common.domain.QImage(forProperty("optionImage")) : null;
        this.question = inits.isInitialized("question") ? new QQuestion(forProperty("question"), inits.get("question")) : null;
        this.questionOptionPK = inits.isInitialized("questionOptionPK") ? new com.cos.cercat.domain.mockExam.domain.embededId.QQuestionOptionPK(forProperty("questionOptionPK")) : null;
    }
