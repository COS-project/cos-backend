...
public class QPostLike extends EntityPathBase<PostLike> {
    ...
    private static final long serialVersionUID = -1745536160L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QPostLike postLike = new QPostLike("postLike");

    public final com.cos.cercat.domain.post.domain.QPost post;

    public final com.cos.cercat.domain.like.domain.EmbeddedId.QPostLikePK postLikePK;
    ...
    public QPostLike(Class<? extends PostLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.cos.cercat.domain.post.domain.QPost(forProperty("post"), inits.get("post")) : null;
        this.postLikePK = inits.isInitialized("postLikePK") ? new com.cos.cercat.domain.like.domain.EmbeddedId.QPostLikePK(forProperty("postLikePK")) : null;
