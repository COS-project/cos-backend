...
public class QInterestCertificate extends EntityPathBase<InterestCertificate> {
    ...
    private static final long serialVersionUID = 1274713230L;
    ...
    public final com.cos.cercat.certificate.domain.embededId.QInterestCertificatePK interestCertificatePK;
    ...
    public QInterestCertificate(Class<? extends InterestCertificate> type, PathMetadata metadata, PathInits inits) {
        ...
        this.interestCertificatePK = inits.isInitialized("interestCertificatePK") ? new com.cos.cercat.certificate.domain.embededId.QInterestCertificatePK(forProperty("interestCertificatePK")) : null;
