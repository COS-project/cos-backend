...
import com.cos.cercat.search.service.facade.SearchDeleteService;
...
public class SearchDeleteApi {
    ...
    private final SearchDeleteService searchDeleteService;
    ...
    public Response<Void> deleteSearchLogs(@AuthenticationPrincipal UserDTO user,
        ...
        searchDeleteService.deleteSearchLog(user, request);
    ...
    public Response<Void> deleteAllSearchLogs(@AuthenticationPrincipal UserDTO user) {
        searchDeleteService.deleteAllSearchLogs(user);
