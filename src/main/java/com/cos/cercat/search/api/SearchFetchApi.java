...
import com.cos.cercat.search.service.facade.SearchFetchService;
...
public class SearchFetchApi {
    ...
    private final SearchFetchService searchFetchService;
    ...
    public Response<Slice<PostResponse>> search(SearchCond cond,
                                                ...
                                                Pageable pageable) {
        return Response.success(searchFetchService.search(cond, user, certificateId, pageable));
    }
    ...
    public Response<List<SearchLog>> getSearchLogs(@AuthenticationPrincipal UserDTO user) {
        return Response.success(searchFetchService.getSearchLogs(user));
    }
    ...
    public Response<List<String>> getAutoCompleteKeywords(@RequestParam String searchText,
                                                          @PathVariable Long certificateId) {
        return Response.success(searchFetchService.getAutoCompleteKeywords(certificateId, searchText));
    }
    ...
    public Response<List<String>> getRecentTop5Keywords(@PathVariable Long certificateId) {
        return Response.success(searchFetchService.getRecentTop5Keywords(certificateId));
    }
