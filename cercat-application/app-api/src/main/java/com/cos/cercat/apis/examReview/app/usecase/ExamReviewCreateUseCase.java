...
//
////        GoalEntity goalEntity = goalService.getRecentGoal(userEntity, certificateEntity);
//        CertificateExamEntity recentCertificateExamEntity = certificateExamService.getRecentCertificateExam(certificateEntity);
//
//        LocalDate prepareStartDate = goalEntity.getPrepareStartDateTime().toLocalDate();
//        LocalDate prepareFinishDate = goalEntity.getPrepareFinishDateTime().toLocalDate();
//
