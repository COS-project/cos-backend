...
public class MockExamResultFetchApi {
    ...
    public Response<Slice<UserAnswerResponse>> getWrongUserAnswers(@PageableDefault() Pageable pageable,
                                                                   ...
                                                                   @AuthenticationPrincipal UserDTO currentUser) {
        return Response.success(mockExamResultFetchUseCase.getWrongUserAnswers(pageable, mockExamResultId, currentUser.getId()));
    }
    ...
    public Response<List<SubjectResultsAVGResponse>> getSubjectResultsAVG(@PathVariable Long certificateId,
                                                                          @AuthenticationPrincipal UserDTO currentUser) {
        return Response.success(mockExamResultFetchUseCase.getSubjectResultsAVG(certificateId, currentUser.getId()));
    }
    ...
    public Response<Report> getReport(@PathVariable Long certificateId,
                                      ...
                                      DateCond dateCond,
                                      @AuthenticationPrincipal UserDTO currentUser) {
        return Response.success(mockExamResultFetchUseCase.getReport(certificateId, reportType, dateCond, currentUser.getId()));
    }
    ...
    public Response<Page<MockExamResultResponse>> getMockExamResultsByDate(@PathVariable Long certificateId,
        ...
        return Response.success(mockExamResultFetchUseCase.getMockExamResultsByDate(certificateId, currentUser.getId(), dateType, dateCond, pageable));
    }
}
