...
/**
 * QInterestCertificate is a Querydsl query type for InterestTarget
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QInterestCertificate extends EntityPathBase<InterestCertificate> {

    private static final long serialVersionUID = 1595643863L;
    ...
    public QInterestCertificate(Class<? extends InterestCertificate> type, PathMetadata metadata, PathInits inits) {
        ...
        this.interestCertificatePK = inits.isInitialized("interestCertificatePK") ? new com.cos.cercat.domain.embededId.QInterestCertificatePK(forProperty("interestCertificatePK")) : null;
