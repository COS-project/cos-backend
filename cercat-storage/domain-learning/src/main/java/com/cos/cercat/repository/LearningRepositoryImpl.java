...
public class LearningRepositoryImpl implements LearningRepository {
    ...
    @Override
    public Goal getRecentGoal(TargetCertificate targetCertificate, TargetUser targetUser) {
        return goalJpaRepository.findRecentGoalByUserIdAndCertificateId(targetUser.userId(), targetCertificate.certificateId())
