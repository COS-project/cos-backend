...
import com.cos.cercat.database.certificate.entity.QCertificateExamEntity;
import com.cos.cercat.database.examreview.entity.QExamReviewEntity;
...
public class ExamReviewJpaRepositoryImpl implements ExamReviewRepositoryCustom {
    ...
    @Override
    public Slice<ExamReviewEntity> searchExamReview(CertificateExamEntity certificateExamEntity,
            ExamReviewSearchCond cond, Pageable pageable) {

        List<ExamReviewEntity> contents = queryFactory.selectFrom(
                        QExamReviewEntity.examReviewEntity)
                .leftJoin(QExamReviewEntity.examReviewEntity.certificateExamEntity,
                        QCertificateExamEntity.certificateExamEntity)
                .where(
                        equalDifficulty(cond.examDifficulty()),
                        betweenPrepareMonths(cond.startMonths(), cond.endPreMonths()),
                        QExamReviewEntity.examReviewEntity.certificateExamEntity.eq(
