...
public enum GlobalErrorCode implements BaseErrorCode {
    ...
    SSE_CONNECT_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "alarm connect error"),
    ...
    FILE_CONVERT_ERROR(HttpStatus.BAD_REQUEST.value(), "file convert error"),
    TYPE_MISMATCH(HttpStatus.BAD_REQUEST.value(), "type mismatch"),
    ALARM_SEND_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "alarm send error");
